...
namespace Immersal.AR
{
    ...
    public class ARMap : MonoBehaviour
    {
        ...
        public void NotifySuccessfulLocalization(int mapId)
        {
            ...
            //GameObject Candles = GameObject.FindGameObjectWithTag("Candle");

            //Candles.transform.position = this.transform.localPosition + new Vector3(0, 0, 0);
            //Candles.transform.position = this.transform.position + new Vector3(-1.464f, -1.378f, -0.328f);
        }
